...
st.markdown("---")
st.subheader("📊 نتائج الفحوصات والتحاليل")

# عرض الأعمدة الرقمية المتاحة في جدول البيانات في رسمة أعمدة مباشرة
try:
    # بيجيب الأعمدة الرقمية ويرسمها فوراً من غير ما يبحث عن أسماء معقدة
